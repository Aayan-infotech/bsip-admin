    ...
    <div class="container-fluid py-3">
        <div class="row gx-5">
            ...
            <div class="col-md-9 content">
                <h3 tabindex="0" aria-label="{{ $language === 'hi' ? 'पीएचडी कार्यक्रम में प्रवेश' : 'Admission to Ph.D. Program' }}">
                    {{ $language === 'hi' ? 'पीएचडी कार्यक्रम में प्रवेश' : 'Admission to Ph.D. Program' }}
                </h3>
                <div class="divider" role="separator" aria-hidden="true"></div>
                <div class="row">
                    <div class="col-md-12">
                        <p class="normal-text" tabindex="0" aria-label="{{ $language === 'hi' ? 'बीएसआईपी विवरण' : 'BSIP Details' }}">
                            {{ $language === 'hi' ?
                ...
                <br>BSIP invites applications from eligible students to pursue their doctoral work in one of the above fields. ' }}
                    ...
                    <div class="col-md-12">
                        <p class="normal-text" tabindex="0" aria-label="{{ $language === 'hi' ? 'पात्रता' : 'Eligibility' }}">
                            <b>{{ $language === 'hi' ? 'पात्रता:' : 'Eligibility:' }}</b>
                        </p>
                        <p class="normal-text" tabindex="0" aria-label="{{ $language === 'hi' ? 'श्रेणी I' : 'Category I' }}">
                ...
                'Candidates with 1st class M.Sc./M.Tech. degree in earth/life science or any other relevant discipline plus CSIR-UGC NET (JRF) qualification/DST INSPIRE Fellowship or any other Fellowship sponsored by government organizations are eligible to apply. ' }}
                        ...
                        <p class="normal-text" tabindex="0" aria-label="{{ $language === 'hi' ? 'श्रेणी II' : 'Category II' }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3 tabindex="0" aria-label="{{ $language === 'hi' ? 'आवेदन प्रक्रिया' : 'Application Process' }}">
                            {{ $language === 'hi' ? 'आवेदन प्रक्रिया' : 'Application Process' }}
                        </h3>
                        <div class="divider" role="separator" aria-hidden="true"></div>
                        <p class="normal-text" tabindex="0" aria-label="{{ $language === 'hi' ? 'आवेदन विवरण' : 'Application Details' }}">
                            {{ $language === 'hi' ?
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3 tabindex="0" aria-label="{{ $language === 'hi' ? 'वैज्ञानिक और नवोन्मेषी अनुसंधान अकादमी (AcSIR)' : 'Academy of Scientific and Innovative Research (AcSIR)' }}">
                            {{ $language === 'hi' ? 'वैज्ञानिक और नवोन्मेषी अनुसंधान अकादमी (AcSIR)' : 'Academy of Scientific and Innovative Research (AcSIR)' }}
                        </h3>
                        <div class="divider" role="separator" aria-hidden="true"></div>
                        <p class="normal-text" tabindex="0" aria-label="{{ $language === 'hi' ? 'AcSIR विवरण' : 'AcSIR Details' }}">
                            {{ $language === 'hi' ?
                ...
                'For more details about the AcSIR admission process, please visit http://acsir.res.in.' }}
                        ...
                        <p tabindex="0" aria-label="{{ $language === 'hi' ? 'डॉ. रतन कर' : 'Dr. Ratan Kar' }}">
                            <i class="fas fa-user"></i> <strong>{{ $language === 'hi' ? 'डॉ. रतन कर' : 'Dr. Ratan Kar' }}</strong>, {{ $language === 'hi' ? 'वैज्ञानिक - एफ' : 'Scientist - F' }}
                        </p>
                        <p tabindex="0" aria-label="{{ $language === 'hi' ? 'ईमेल: ratan_kar@bsip.res.in' : 'Email: ratan_kar@bsip.res.in' }}">
                            <i class="fas fa-envelope"></i> Email: <a href="mailto:ratan_kar@bsip.res.in">ratan_kar@bsip.res.in</a>
                        </p>
                    </div>
                </div>
            </div>
