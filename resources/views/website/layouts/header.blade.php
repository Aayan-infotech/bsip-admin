                    ...
                    <div class="common-right clearfix">
                        <ul id="header-nav">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a target="_blank" title="Social Link"
                                            href="{{ $link->url }}"><img
                                                alt="Social Link" src="{{ asset('storage/' . $link->icon_image) }}"></a>
                                    </li>
                                    @endforeach
                                </ul>
                            </li>
                            ...
                            <li class="hindi cmf_lan m-hide">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ url('/en') }}" lang="en" class="alink" title="Click here for English version." {{ $language === 'en' ? 'aria-current="page"' : '' }}>English</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/hi') }}" lang="hi" class="alink" title="Click here for हिन्दी version." {{ $language === 'hi' ? 'aria-current="page"' : '' }}>हिन्दी</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
