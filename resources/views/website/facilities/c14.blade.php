                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="card h-100">
                                        <img src="{{ asset('assets-new/assets/images/c14/c14_bpu.jpg') }}"
                                            class="card-img-top-saif img-fluid" alt="Benzene Preparation Unit" title="Benzene Preparation Unit">
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="card h-100">
                                        <img src="{{ asset('assets-new/assets/images/c14/c14_lsbc.jpg') }}"
                                            class="card-img-top-saif img-fluid" alt="Liquid Scintillation Beta Counter" title="Liquid Scintillation Beta Counter">
                                        <div class="card-body text-center p-2">
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="card h-100">
                                        <img src="{{ asset('assets-new/assets/images/c14/c14_gps.jpg') }}"
                                            class="card-img-top-saif img-fluid" alt="Newly established Automated Graphite preparation system for AMS C-14 dating" title="Newly established Automated Graphite preparation system for AMS C-14 dating">
                                        <div class="card-body text-center p-2">
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="card h-100">
                                        <img src="{{ asset('assets-new/assets/images/c14/c14_new_gps.jpg') }}"
                                            class="card-img-top-saif img-fluid" alt="Elemental Analyzer (EA)" title="Elemental Analyzer (EA)">
                                        <div class="card-body text-center p-2">
                                            <h5 class="card-title">
