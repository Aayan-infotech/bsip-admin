            ...
            <div class="row gx-5">
                ...
                <div class="col-md-9 content">
                    ...
                    <div class="accordion" id="accordionExample">
                        @if ($scientificSection->isNotEmpty())
                            @foreach ($scientificSection as $subCategory)
                                                    ...
                                                    <div class="row">
                                                        @foreach ($subCategory->staff as $member)
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="profile-info-new">
                                                                    ...
                                                                    <a href="profile-detail.php"
                                                                        class="btn btn-md mt-4 btn-view-profile"
                                                                        role="button" aria-label="View Profile">
                                                                        View Profile <i class="fas fa-arrow-right ms-2"
                                                                            aria-hidden="true"></i>
                                                                    </a>
                                                                </div>
                                                            </div> --}}
                                                            ...
                                                            <div class="col-md-4 imgcard-new">
                                                                <div class="profile-img-new">
                                                                    <img src="{{ asset($member->profile_picture) }}"
                                                                        alt="{{ $member->name }}" title="Scientific Image">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <div class="profile-info-new">
                                                                    ...
                                                                    <div class="contact-new">
                                                                        <a href="tel:{{ $member->mobile_no }}"><i
                                                                                class="fas fa-phone"></i>
                                                                            {{ $member->mobile_no ?? 'N/A' }}</a> <br>
                                                                        <a href="mailto:{{ $member->email }}"><i
                                                                                class="fas fa-envelope"></i>
                                                                            {{ $member->email ?? 'N/A' }}</a>

                                                                    </div>
                                                                    <a href="{{ route('frontend.profileDetails', ['language' => $language, 'staffid' => $member->employee_id]) }}"
                                                                        class="btn btn-md mt-4 btn-view-profile"
                                                                        role="button" aria-label="{{ $language === 'hi' ? 'प्रोफ़ाइल देखें' : 'View Profile' }}">
                                                                        {{ $language === 'hi' ? 'प्रोफ़ाइल देखें' : 'View Profile' }}<i class="fas fa-arrow-right ms-2" aria-hidden="true"></i>
                                                                     </a>
                                                                </div>
                                                            </div>
                                                        @endforeach
