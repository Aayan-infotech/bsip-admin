...
<section id="fontSize" class="wrapper body-wrapper ">
                    ...
                    <div class="card shadow border-0">
                        ...
                        <div class="card-body d-flex justify-content-center align-items-center">
                            <div class="row justify-content-center g-4">
                                ...
                                <div class="col-6">
                                    <a href="https://youtu.be/NpKQ1LPbrfE" class="card-link text-decoration-none" role="link" aria-label="home" target="_blank">
                                        <div class="card-section border rounded text-center p-2">
                                            <div class="icon-container bg-success text-white d-flex justify-content-center align-items-center mx-auto">
                                                <i class="fas fa-flask fa-1x" role="presentation"></i>
                                            </div>
                                            <p class="mt-2 fw-bold">{{ $language === 'hi' ? 'प्लैटिनम जुबली मूवी (अंग्रेजी)' : 'Platinum Jubilee Movie (English)' }}</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="https://www.youtube.com/watch?v=NpKQ1LPbrfE" class="card-link text-decoration-none" role="link" aria-label="home" target="_blank">
                                        <div class="card-section border rounded text-center p-2">
                                            <div class="icon-container bg-warning text-white d-flex justify-content-center align-items-center mx-auto">
                                                <i class="fas fa-film fa-1x" role="presentation"></i>
                                            </div>
                                            <p class="mt-2 fw-bold">{{ $language === 'hi' ? 'प्लैटिनम जुबली फिल्म (हिंदी)' : 'Platinum Jubilee Movie (Hindi)' }}</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="https://www.youtube.com/@bsiponline573" class="card-link text-decoration-none" role="link" aria-label="home" target="_blank">
                                        <div class="card-section border rounded text-center p-3">
                                            <div class="icon-container bg-danger text-white d-flex justify-content-center align-items-center mx-auto">
                                                <i class="fas fa-video fa-1x" role="presentation"></i>
                                            </div>
                                            <p class="mt-2 fw-bold">{{ $language === 'hi' ? 'यूट्यूब पुरानी फिल्में' : 'YouTube Old Movies' }}</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="col-6">
                                    <a href="{{ $language}}/{{ $language === 'hi' ? 'bsip_short_term_training_program' : 'bsip_short_term_training_program' }}" class="card-link text-decoration-none" role="link" aria-label="home">
                                        <div class="card-section border rounded text-center p-2">
                                            ...
                                            <p class="mt-2 fw-bold">{{ $language === 'hi' ? 'अनुसंधान विद्वानों के लिए बीरबल साहनी प्रशिक्षण कार्यक्रम' : 'Birbal Sahni Training Programs For Research Scholars' }}</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="{{ $language}}/{{ $language === 'hi' ? 'bsip_master_dissertation_program' : 'bsip_master_dissertation_program' }}" class="card-link text-decoration-none" role="link" aria-label="home">
                                        <div class="card-section border rounded text-center p-3">
                                            ...
                                            <p class="mt-2 fw-bold">{{ $language === 'hi' ? 'बीरबल साहनी प्रशिक्षण कार्यक्रम के लिए शोध विद्वान' : "Master's Dissertation Programs at BSIP" }}</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="{{ $language}}/{{ $language === 'hi' ? 'bsip_admission_to_phd' : 'bsip_admission_to_phd' }}" class="card-link text-decoration-none" role="link" aria-label="home">
                                        <div class="card-section border rounded text-center p-3">
                                            ...
                                            <p class="mt-2 fw-bold">{{ $language === 'hi' ? 'पीएचडी में प्रवेश' : 'Admission to PhD' }}</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="{{ $language}}/{{ $language === 'hi' ? 'bsip_career' : 'bsip_career' }}" class="card-link text-decoration-none" role="link" aria-label="home">
                                        <div class="card-section border rounded text-center p-3">
                                            ...
                                            <p class="mt-2 fw-bold">{{ $language === 'hi' ? 'विज्ञापन' : 'Advertisement' }}</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="col-6">
                                    <a href="{{ $language}}/{{ $language === 'hi' ? 'bsip_scientific' : 'bsip_scientific' }}" class="card-link text-decoration-none" role="link" aria-label="home">
                                        <div class="card-section border rounded text-center p-3">
                                            ...
                                            <p class="mt-2 fw-bold">{{ $language === 'hi' ? 'वैज्ञानिक' : 'Scientific' }}</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="{{ $language}}/{{ $language === 'hi' ? 'bsip_technical_staff' : 'bsip_technical_staff' }}" class="card-link text-decoration-none" role="link" aria-label="home">
                                        <div class="card-section border rounded text-center p-3">
                                            ...
                                            <p class="mt-2 fw-bold">{{ $language === 'hi' ? 'तकनीकी' : 'Technical' }}</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="{{ $language}}/{{ $language === 'hi' ? 'bsip_administrative' : 'bsip_administrative' }}" class="card-link text-decoration-none" role="link" aria-label="home">
                                        <div class="card-section border rounded text-center p-3">
                                            ...
                                            <p class="mt-2 fw-bold">{{ $language === 'hi' ? 'प्रशासनिक' : 'Administrative' }}</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="{{ $language}}/{{ $language === 'hi' ? 'bsip_superannuated_employee' : 'bsip_superannuated_employee' }}" class="card-link text-decoration-none" role="link" aria-label="home">
                                        <div class="card-section border rounded text-center p-3">
                                            ...
                                            <p class="mt-2 fw-bold">{{ $language === 'hi' ? 'वयोवृद्ध' : 'Superannuated' }}</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <a href="{{ $language}}/{{ $language === 'hi' ? 'bsip_museum' : 'bsip_museum' }}" class="text-decoration-none" role="link" aria-label="home">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <img src="{{ $language === 'hi' ? 'https://www.bsip.res.in/images/nav/museum2.jpg' : 'assets-new/assets/images/home/museum2.jpg' }}" alt="museum-img" class="img-fluid img-museum">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <a href="{{ $language}}/{{ $language === 'hi' ? 'bsip_geo_heritage' : 'bsip_geo_heritage' }}" class="text-decoration-none" role="link" aria-label="home">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <img src="{{ $language === 'hi' ? 'https://www.bsip.res.in/museumpics/cpgg.jpg' : 'assets-new/assets/images/home/cpgg.jpg' }}" alt="cpgg-img" class="img-fluid img-museum">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <a href="{{ $language}}/{{ $language === 'hi' ? 'bsip_media_cell' : 'bsip_media_cell' }}" class="text-decoration-none" role="link" aria-label="home">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <img src="{{ $language === 'hi' ? 'https://www.bsip.res.in/images/media-cell-eng.jpg' : 'assets-new/assets/images/home/media-cell-eng.jpg' }}" alt="cell-img" class="img-fluid img-museum">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="main-contents-home-page">
        <div class="container-fluid heading-facilities-home">
            <h2 class="header-section-profiles m-0 text-center bg-primary text-white py-3" aria-label="{{ $language === 'hi' ? 'सुविधाएँ' : 'Facilities' }}">
                <i class="fas fa-microscope me-2" role="presentation"></i>
        ...
        <div class="container-fluid container-slider-facilities">
            <div class="carousel-facilities">
                <button class="btn-slider-home btn-left" onclick="slideLeft();" aria-label="{{ $language === 'hi' ? 'बाएं स्लाइड करें' : 'Slide Left' }}">
                ...
                <button class="btn-slider-home btn-right" onclick="slideRight();" aria-label="{{ $language === 'hi' ? 'दाएं स्लाइड करें' : 'Slide Right' }}">
        ...
        <div class="container common-container four_content gallery-container">
            <div class="gallery-area clearfix">
                ...
                <div class="fancybox">
                    <ul class="slider">
                        <li>
                            <a href="https://www.bsip.res.in/admin/assets/img/BSIPRAJBHASHA45_15_15_09_PM_5425.JPG" data-fancybox="images">
                                <img src="https://www.bsip.res.in/admin/assets/img/BSIPRAJBHASHA45_15_15_09_PM_5425.JPG" alt="Photo Gallery Slide 1" class="photo-gallery-img" />
                            </a>
                        </li>
                        <li>
                            <a href="https://www.bsip.res.in/admin/assets/img/BSIPRAJBHASHA44_15_08_35_PM_6291.JPG" data-fancybox="images">
                                <img src="https://www.bsip.res.in/admin/assets/img/BSIPRAJBHASHA44_15_08_35_PM_6291.JPG" alt="Photo Gallery Slide 2" class="photo-gallery-img" />
                            </a>
                        </li>
                        <li>
                            <a href="https://www.bsip.res.in/admin/assets/img/BSIPRAJBHASHA43_14_35_34_PM_9076.JPG" data-fancybox="images">
                                <img src="https://www.bsip.res.in/admin/assets/img/BSIPRAJBHASHA43_14_35_34_PM_9076.JPG" alt="Photo Gallery Slide 3" class="photo-gallery-img" />
                            </a>
                        </li>
                        <li>
                            <a href="https://www.bsip.res.in/admin/assets/img/BSIPRAJBHASHA45_15_15_09_PM_5425.JPG" data-fancybox="images">
            ...
            <div class="gallery-right">
                ...
                <div class="video-wrapper">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/NpKQ1LPbrfE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
