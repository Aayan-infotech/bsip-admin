            ...
            <div class="row gx-5">
                ...
                <div class="col-md-9 content">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'बीएसआईपी में द्विवार्षिक मास्टर्स डिसर्टेशन प्रोग्राम' : 'BIRBAL SAHNI BIANNUAL MASTERS DISSERTATION PROGRAMS AT BSIP' }}">
                            ...
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'बीएसआईपी का विवरण' : 'BSIP Details' }}">
                                {{ $language === 'hi'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'कार्यक्रम की अवधि' : 'Program Duration' }}">
                                {{ $language === 'hi' ? 'कार्यक्रम की अवधि' : 'Program Duration' }}
                            </h3>
                            <div class="divider" role="separator" aria-hidden="true"></div>
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'कार्यक्रम की अवधि विवरण' : 'Program Duration Details' }}">
                                {{ $language === 'hi'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'आवेदन प्रक्रिया' : 'Application Procedure' }}">
                                {{ $language === 'hi' ? 'आवेदन प्रक्रिया' : 'Application Procedure' }}
                            </h3>
                            <div class="divider" role="separator" aria-hidden="true"></div>
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'आवेदन प्रक्रिया विवरण' : 'Application Procedure Details' }}">
                                {{ $language === 'hi'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="divider" role="separator" aria-hidden="true"></div>
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'शुल्क विवरण' : 'Fee Details' }}">
                                {{ $language === 'hi'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="divider" role="separator" aria-hidden="true"></div>
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'सुविधा विवरण' : 'Facility Details' }}">
                                {{ $language === 'hi'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'प्रोजेक्ट रिपोर्ट' : 'Project Report' }}">
                                {{ $language === 'hi' ? 'प्रोजेक्ट रिपोर्ट' : 'Project Report' }}
                            </h3>
                            <div class="divider" role="separator" aria-hidden="true"></div>
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'प्रोजेक्ट रिपोर्ट विवरण' : 'Project Report Details' }}">
                                {{ $language === 'hi'
