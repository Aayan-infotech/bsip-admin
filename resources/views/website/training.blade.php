            ...
            <div class="row gx-5">
                ...
                <div class="col-md-9 content">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'बीरबल साहनी अनुसंधान के लिए अल्पावधि प्रशिक्षण कार्यक्रम विद्वान, स्नातकोत्तर और स्नातक छात्र' : 'BIRBAL SAHNI SHORT TERM TRAINING PROGRAMS FOR RESEARCH SCHOLARS, POSTGRADUATE AND UNDERGRADUATE STUDENTS' }}">
                                {{ $language === 'hi' ? 'बीरबल साहनी अनुसंधान के लिए अल्पावधि प्रशिक्षण कार्यक्रम विद्वान, स्नातकोत्तर और स्नातक छात्र' : 'BIRBAL SAHNI SHORT TERM TRAINING PROGRAMS FOR RESEARCH SCHOLARS, POSTGRADUATE AND UNDERGRADUATE STUDENTS' }}
                            </h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'बीएसआईपी निम्नलिखित क्षेत्रों में प्रशिक्षण प्रदान करता है' : 'BSIP offers training in the following fields' }}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="divider" role="separator" aria-hidden="true"></div>
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'पात्रता  विवरण' : 'ELIGIBILITY Details' }}">
                                {{ $language === 'hi'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'कार्यक्रम की अवधि और प्रशिक्षुओं की संख्या ' : 'PROGRAM DURATION AND NUMBER OF TRAINEES ' }}">
                                {{ $language === 'hi' ? 'कार्यक्रम की अवधि और प्रशिक्षुओं की संख्या ' : 'PROGRAM DURATION AND NUMBER OF TRAINEES ' }}
                            </h3>
                            <div class="divider" role="separator" aria-hidden="true"></div>
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'कार्यक्रम की अवधि और प्रशिक्षुओं की संख्या  विवरण' : 'PROGRAM DURATION AND NUMBER OF TRAINEES  Details' }}">
                                {{ $language === 'hi'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'आवेदन की प्रक्रिया ' : 'APPLICATION PROCEDURE ' }}">
                                {{ $language === 'hi' ? 'आवेदन की प्रक्रिया ' : 'APPLICATION PROCEDURE ' }}
                            </h3>
                            <div class="divider" role="separator" aria-hidden="true"></div>
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'आवेदन की प्रक्रिया  विवरण' : 'APPLICATION PROCEDURE  Details' }}">
                                {{ $language === 'hi'
                                    ? 'वर्ष के किसी भी समय दो सप्ताह तक। अधिकतम दो प्रशिक्षु होंगे हर साल बीएसआईपी से एक सलाहकार को सौंपा जाता है। तथापि, बीएसआईपी निदेशक को यह अधिकार है कि वह किसी भी छात्र का चयन नहीं कर सकते, बढ़ा नहीं सकते के आधार पर प्रशिक्षुओं की संख्या कम करें उसके आवेदन की योग्यता के आधार पर। '
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'कार्यक्रम की लागत ' : 'COST OF THE PROGRAM ' }}">
                                {{ $language === 'hi' ? 'कार्यक्रम की लागत ' : 'COST OF THE PROGRAM ' }}
                            </h3>
                            <div class="divider" role="separator" aria-hidden="true"></div>
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'कार्यक्रम की लागत  विवरण' : 'COST OF THE PROGRAM  Details' }}">
                                {{ $language === 'hi'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'आवास, चिकित्सा और कैंटीन सुविधाएं ' : 'ACCOMMODATION, MEDICAL AND CANTEEN FACILITIES ' }}">
                                {{ $language === 'hi' ? 'आवास, चिकित्सा और कैंटीन सुविधाएं ' : 'ACCOMMODATION, MEDICAL AND CANTEEN FACILITIES ' }}
                            </h3>
                            <div class="divider" role="separator" aria-hidden="true"></div>
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'आवास, चिकित्सा और कैंटीन सुविधाएं  विवरण' : 'ACCOMMODATION, MEDICAL AND CANTEEN FACILITIES  Details' }}">
                                {{ $language === 'hi'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="divider" role="separator" aria-hidden="true"></div>
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'अनुशासन  विवरण' : 'DISCIPLINE  Details' }}">
                                {{ $language === 'hi'
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'परियोजना रिपोर्ट ' : 'PROJECT REPORT  ' }}">
                                {{ $language === 'hi' ? 'परियोजना रिपोर्ट ' : 'PROJECT REPORT  ' }}
                            </h3>
                            <div class="divider" role="separator" aria-hidden="true"></div>
                            <p class="normal-text" tabindex="0"
                                aria-label="{{ $language === 'hi' ? 'परियोजना रिपोर्ट  विवरण' : 'PROJECT REPORT   Details' }}">
                                {{ $language === 'hi'
