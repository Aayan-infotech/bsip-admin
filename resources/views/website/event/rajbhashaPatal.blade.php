            ...
            <nav class="bio-breadcrumb" aria-label="Breadcrumb">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ $language === 'hi' ? 'राजभाषा पटल' : 'RajBhasha Portal' }}
                    </li>
                </ul>
            </nav>
        </div>
                    ...
                    <div class="col-md-4">
                        <div class="text-end">
                            @if ($event->pdf_file)
                                ...
                                <a href="{{ $event->pdf_file }}" class="btn btn-view-profile" target="_blank" onclick="return confirmExternalLink()" role="button"
                        ...
                        @foreach ($event->images as $image)
                            <div class="col-md-3">
                                <div class="card-event">
                                    <img src="{{ $image }}" class="card-img-event" alt="Event Image 1" title="Event Image">
