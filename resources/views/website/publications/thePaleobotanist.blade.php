        ...
        <div class="container py-3">
            <div class="row gx-5">
                ...
                <div class="col-md-9 content">
                    ...
                    <a href="https://www.jpsonline.co.in/index.php/jop" class="btn btn-view-profile" target="_blank">
                        <i class="fas fa-download"></i> {{ $language === 'hi' ? 'जर्नल देखें' : 'View Journal'}}
                    </a>
                </div>
            </div>
        </div>
