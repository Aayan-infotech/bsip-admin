      ...
      <nav class="main-menu clearfix" id="main_menu">
        <ul class="nav-menu">
          ...
          <li class="nav-item">
            ...
            <div class="sub-nav">
              <ul class="sub-nav-group">
                ...
                <li><a href="hindi-parental-background.php" role="link" aria-label="Biography">पैतृक
                    पृष्ठभूमि</a></li>
                <li><a href="hindi-education-career.php" role="link" aria-label="Publications">शैक्षिक योग्यताएं</a>
                </li>
                <li><a href="hindi-general-interest.php" role="link" aria-label="Contributions">सामान्य रूचि</a></li>
                <li><a href="hindi-incident-of-youth.php" role="link" aria-label="Awards">युवाओं का
                    वृत्तांत</a></li>
                <li><a href="hindi-honours.php" role="link" aria-label="Awards">सम्मान</a>
                </li>
                <li><a href="hindi-living.php" role="link" aria-label="living">जीविका</a></li>
                <li><a href="hindi-fossil.php" role="link" aria-label="fossil">जीवाश्म</a></li>
                <li><a href="hindi-geology.php" role="link" aria-label="geology">भूगर्भ विज्ञान</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="sub-nav">
              <ul class="sub-nav-group">
                ...
                <li><a href="hindi-administrative.php" role="link" aria-label="Administrative Staff Page">प्रशासनिक</a>
                </li>
                <li><a href="hindi-superannuated.php" role="link" aria-label="Superannuated Staff Page">वयोवृद्ध</a>
                </li>
              </ul>
          ...
          <li class="nav-item">
            ...
            <div class="sub-nav">
              <ul class="sub-nav-group">
                <li><a href="hindi-research-activities.php" role="link" aria-label="home">अनुसंधान
                    गतिविधियाँ</a>
                </li>
                <li><a href="hindi-collaborations.php" role="link" aria-label="home">सहयोग</a></li>
                <li><a href="hindi-sponsored-projects.php" role="link" aria-label="home">प्रायोजित
                    परियोजनाएं</a>
                </li>
                <li><a href="hindi-fellowships.php" role="link" aria-label="home">फेलोशिप</a></li>
                <li><a href="hindi-medals-and-awards.php" role="link" aria-label="home">पदक एवं पुरस्कार</a>
                </li>
                <li><a href="hindi-lectures.php" role="link" aria-label="home">व्याख्यान</a></li>
                <li><a href="hindi-consultancy.php" role="link" aria-label="home">Consultancy</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="sub-nav">
              <ul class="sub-nav-group">
                <li><a href="hindi-palaeosciences.php" role="link" aria-label="home">जर्नल ऑफ
                    पैलियोसाइंसेज</a></li>
                <li><a href="hindi-annual-reports.php" role="link" aria-label="home">वार्षिक विवरणिका</a>
                </li>
                <li><a href="hindi-catalogues.php" role="link" aria-label="home">केटलौग/मोनोग्राफ</a></li>
                <li><a href="hindi-publications-on-sale.php" role="link" aria-label="home">प्रकाशन विक्रय</a></li>
                <li><a href="hindi-research-highlights-all.php" role="link" aria-label="home">शोध पत्र</a>
                </li>
                <li><a href="hindi-monthly-report.php" role="link" aria-label="home">मासिक रिपोर्ट</a></li>
                <li><a href="hindi-newsletter.php" role="link" aria-label="home">समाचार पत्रिका</a></li>
                <li><a href="hindi-e-magazine.php" role="link" aria-label="home"> ई-पत्रिका</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="sub-nav">
              <ul class="sub-nav-group">
                <li><a href="hindi-museum.php" role="link" aria-label="home">संग्रहालय</a></li>
                <li><a href="hindi-knowledge-resource-centre.php" role="link" aria-label="home">ज्ञान संसाधन केंद्र</a></li>
                <li><a href="hindi-computer-section.php" role="link" aria-label="home">कंप्यूटर अनुभाग</a>
                </li>
                <li><a href="hindi-cpgg.php" role="link" aria-label="home">भू-विरासत एवं भू-पर्यटन
                    संवर्धन केंद्र
                    (सीपीजीजी)</a></li>
                <li><a href="hindi-amber-lab.php" role="link" aria-label="home">एम्बर विश्लेषण और
                    पैलियोएंटोमोलॉजी
                    प्रयोगशाला</a></li>
          ...
          <li class="nav-item"><a href="hindi-tenders.php" role="link" aria-label="home">निविदा</a></li>
          <li class="nav-item">
